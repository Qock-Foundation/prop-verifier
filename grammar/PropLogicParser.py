...
def serializedATN():
    return [
        ...
        29,8,2,1,3,1,3,1,3,1,3,1,3,1,3,5,3,37,8,3,10,3,12,3,40,9,3,1,4,1,
        4,1,4,1,4,1,4,3,4,47,8,4,1,5,1,5,1,5,3,5,52,8,5,1,6,1,6,1,6,1,6,
        1,6,1,6,1,6,1,6,1,6,1,6,3,6,64,8,6,1,6,0,1,6,7,0,2,4,6,8,10,12,0,
        0,66,0,14,1,0,0,0,2,21,1,0,0,0,4,28,1,0,0,0,6,30,1,0,0,0,8,46,1,
        0,0,0,10,51,1,0,0,0,12,63,1,0,0,0,14,15,3,2,1,0,15,1,1,0,0,0,16,
        22,3,4,2,0,17,18,3,4,2,0,18,19,5,6,0,0,19,20,3,4,2,0,20,22,1,0,0,
        0,21,16,1,0,0,0,21,17,1,0,0,0,22,3,1,0,0,0,23,29,3,6,3,0,24,25,3,
        6,3,0,25,26,5,7,0,0,26,27,3,4,2,0,27,29,1,0,0,0,28,23,1,0,0,0,28,
        24,1,0,0,0,29,5,1,0,0,0,30,31,6,3,-1,0,31,32,3,8,4,0,32,38,1,0,0,
        0,33,34,10,1,0,0,34,35,5,8,0,0,35,37,3,8,4,0,36,33,1,0,0,0,37,40,
        1,0,0,0,38,36,1,0,0,0,38,39,1,0,0,0,39,7,1,0,0,0,40,38,1,0,0,0,41,
        47,3,10,5,0,42,43,3,10,5,0,43,44,5,9,0,0,44,45,3,8,4,0,45,47,1,0,
        0,0,46,41,1,0,0,0,46,42,1,0,0,0,47,9,1,0,0,0,48,52,3,12,6,0,49,50,
        5,10,0,0,50,52,3,10,5,0,51,48,1,0,0,0,51,49,1,0,0,0,52,11,1,0,0,
        0,53,64,5,5,0,0,54,64,5,11,0,0,55,56,5,1,0,0,56,57,3,0,0,0,57,58,
        5,2,0,0,58,64,1,0,0,0,59,60,5,3,0,0,60,61,3,0,0,0,61,62,5,4,0,0,
        62,64,1,0,0,0,63,53,1,0,0,0,63,54,1,0,0,0,63,55,1,0,0,0,63,59,1,
        0,0,0,64,13,1,0,0,0,6,21,28,38,46,51,63
    ]
...
class PropLogicParser ( Parser ):
    ...
    symbolicNames = [ "<INVALID>", "<INVALID>", "<INVALID>", "<INVALID>", 
                      "<INVALID>", "NameStr", "EquivStr", "ImpliesStr", 
                      "OrStr", "AndStr", "NotStr", "FalseStr", "WS" ]
    ...
    def conjunctionExpr(self):
        ...
        self.enterRule(localctx, 8, self.RULE_conjunctionExpr)
        try:
            self.state = 46
            self._errHandler.sync(self)
    ...
    class AtomicExprContext(ParserRuleContext):
        ...
        def NameStr(self):
            return self.getToken(PropLogicParser.NameStr, 0)
    ...
    def atomicExpr(self):
        ...
        try:
            ...
            if token in [5]:
                self.enterOuterAlt(localctx, 1)
                self.state = 53
                self.match(PropLogicParser.NameStr)
                pass
            elif token in [11]:
                self.enterOuterAlt(localctx, 2)
                self.state = 54
